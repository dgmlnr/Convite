...
// Tasks 15a.1-15a.4 — the FIRST real writes this app performs against
// `TenantAdminRepository` from an actual route (design §2.3's write port,
// built in slice 4, unconsumed by any handler until now). Both build their
// own `WriteWitness` as `(exec) => appendAuditEntry(exec, {...})`, the exact
