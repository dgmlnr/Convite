 ...
 *
 * Named debt: duplicated by hand from
 * `packages/games/truco-ui/src/focus-continuity.ts` — neither UI package may
 * import the other, and a shared DOM-utils package for two small files was
 * judged heavier than the duplication it removes.
 */
